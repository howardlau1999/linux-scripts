...
export ZSH="/home/howard/.oh-my-zsh"
...
__conda_setup="$('/home/howard/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/howard/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/howard/anaconda3/etc/profile.d/conda.sh"
    else
